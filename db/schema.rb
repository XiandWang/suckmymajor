...
ActiveRecord::Schema.define(version: 20151030194153) do
  ...
  add_index "likes", ["bet_id"], name: "index_likes_on_bet_id"
  add_index "likes", ["user_id", "bet_id"], name: "index_likes_on_user_id_and_bet_id", unique: true
